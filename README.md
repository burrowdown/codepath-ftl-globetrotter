...
Deployed Application (optional): [Globetrotter Deployed Site](https://burrow.dev/codepath-ftl-globetrotter/)
...
- [x] **Home Page**
  ...
  - [x] An evocative image that represents the location.
    - **I think the background image should count for this**
...
- [x] **Guide Page (Choose One)**
  ...
  - [x] At least three entries thematic to your choice that provide a:
    - [x] Title
    - [x] Address
      - \*\* There aren't addresses in the Canyon! I did my best.
    - [x] Description
...
None, unless you want to count Google Fonts

### Shout out

Jude answered some logistical questions about the submission :)
